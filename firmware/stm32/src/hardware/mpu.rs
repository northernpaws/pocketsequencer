...
bitfield! {
    ...
    pub struct RegionAttributeSizeRegister (pub u32) {
        /// Instruction access disable bit:
        /// 0 = instruction fetches enabled
        /// 1 = instruction fetches disabled.
        instruction_access_disabled: bool @ 28,
        ...
        access_permission: u8 @ 24..=26,
        
        /// Memory access attributes.
        /// 
        /// see: https://developer.arm.com/documentation/dui0552/a/cortex-m3-peripherals/optional-memory-protection-unit/mpu-access-permission-attributes?lang=en
        memory_access_attribute_tex: u8 @ 19..=21,
        memory_access_attribute_c: bool @ 17,
        memory_access_attribute_b: bool @ 16,
